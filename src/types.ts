...
export interface ActBeeGranteesResult {
  ref: SwarmRef;
  historyref: SwarmRef;
}

export interface ActBeeGetGranteesResult {
  grantees: PublicKeyBytes[];
}

export interface ActBeePatchGranteesArgs {
  add?: PublicKeyInput[];
  revoke?: PublicKeyInput[];
}

export interface ActBeeUploadOptions {
  actHistoryAddress: ReferenceInput;
  requestOptions?: unknown;
  [key: string]: unknown;
}

export interface ActBeeDownloadOptions {
  actHistoryAddress: ReferenceInput;
...
export interface ActBeeUploadResult extends UploadDataResultLike {
  historyAddress: SwarmRef;
}
